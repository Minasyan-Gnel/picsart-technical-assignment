...
import { PhotoDetailsContainerStyled, PhotoDetailsHeaderStyled, PhotoDetailsStyled, PhotoDetailsImageInfoStyled, PhotoDetailsImageWrapperStyled, BackButtonStyled, PhotoDetailsInfoStyled } from './styles';
